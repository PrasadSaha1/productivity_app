...
urlpatterns = [
     ...
     path('create_scheduler/', views.create_scheduler, name='create_scheduler'),
     ...
     path('view_single_schedule/<int:id>/', views.view_single_schedule, name='view_single_schedule'),
     path('modify_schedule/<int:id>/', views.modify_schedule, name='modify_schedule'),
]
